...
router.post('/', cpf_validate_1.default.CPFBodyFormatValidate, cpf_validate_1.default.checkIfCPFAlreadyExist, cpf_controller_1.default.addCPFToRestrictedList);
router.delete('/:cpf', cpf_validate_1.default.CPFParamsFormatValidate, cpf_validate_1.default.checkIfCPFExist, cpf_controller_1.default.deleteCPFOnRestrictedList);
